...
The complete replication of all the results in the paper is time-consuming and requires hours to generate all the results, depending on the hardware.

We suggest that the reviewers replicate only the results for the tool configuration V1. This would require around 2 hours.  
